classdef Model < handle
    ...
    methods % modified
        ...
        function callback_updateSimpleTriggerDirection(obj,val)
        ...
        function callback_captureData(obj,stopFlag)
            ...
            obj.setTimeBase();
            [obj.status.runBlock] = obj.runBlock(obj.BlockGroupObj,0,stopFlag);
        ...
        function [status,timeIndisposedMs] = runBlock(DeviceObj,segmentIndex,stopFlg)
